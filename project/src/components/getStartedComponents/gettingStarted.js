...
const GettingStarted = ({ onStartClick }) => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 p-6">
            <div className="border bg-white shadow-2xl rounded-2xl border-gray-100 p-10 max-w-md w-full text-center transform transition-all hover:scale-105 duration-300 ease-out">
