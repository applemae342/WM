...
const HomePageContent = () => {
    return (
        <div className="relative bg-[#FBFBFE] text-gray-1000 w-1/2 py-10 mt-60 md:py-4 px-8 md:px-16 flex flex-col items-center rounded-lg shadow-2xl max-w-3xl right-[-5px] font-sans">
            {" "}
            {/* Added font-sans for Open Sans */}
            {/* Content Section - Centered */}
            <div className="text-center mb-8">
                <h2 className="text-[28px] mt-10 font-bold mb-4 leading-tight text-gray-900">Innovative Waste Solutions</h2>
