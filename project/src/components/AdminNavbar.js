    ...
    return (
        <nav className="fixed top-0 w-full bg-gray-50 shadow-md z-50 font-sans">
            <div className="flex items-center justify-start h-16 px-0">
                ...
                <div className="relative mr-4 ml-auto">
                    {" "}
                    {/* Use ml-auto to push profile icon to the right */}
                    <img src="/images/user.png" alt="Profile" className="h-10 w-10 rounded-full cursor-pointer" onClick={toggleDropdown} />
                    {isDropdownOpen && (
