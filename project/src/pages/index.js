    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-r from-[#2E8ECA] to-white">
            ...
            <main className="container mx-auto px-4 relative z-20">
                ...
                {/* About Section */}
                <section id="about" className="mt-40 py-12 px-8 rounded-lg bg-white shadow-lg" data-aos="fade-left">
                    {" "}
                ...
                {/* Contact Section */}
                <section id="contact" className="mt-36 py-12 rounded-lg bg-white shadow-lg" data-aos="fade-right">
                    {" "}
                    {/* Ensure no overlap */}
                    <Contact />
                </section>
            ...
            {/* Footer */}
            <footer className="bg-[#1F4F7A] text-white py-4 relative z-20 mt-12">
                {" "}
                {/* Changed footer background to a solid color */}
